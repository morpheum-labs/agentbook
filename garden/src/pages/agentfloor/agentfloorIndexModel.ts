...
export function minimalPanelFromRow(row: IndexDirectoryRow): SelectedIndexPanelModel {
  ...
  return {
    ...
    openDetailUrl: row.openDetailUrl || `/index/${encodeURIComponent(row.indexId)}`,
        ...
        : indexId === "I.02"
          ...
          : indexId === "I.03"
            ...
            : indexId === "I.04"
              ? "Bullish drift MTD"
              : "Bullish divergence",
    openDetailUrl: `/index/${encodeURIComponent(indexId)}`,
    canWatchlist: true,
